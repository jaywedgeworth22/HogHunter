...
| Mon, Sep 8, 2026 | CLAUDE | claude/hog-hunter-overhaul | In review (#3) | Owner-directed takeover after the audit: pid identity and wrap guard, footprint memory, history math, swap and pressure, visible-vs-invisible accounting, safer quit, grouping identity, settings, tests, CI, install script.  Design: docs/DESIGN.md |
